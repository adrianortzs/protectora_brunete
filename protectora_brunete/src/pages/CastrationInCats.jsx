      ...
      <main className="collab-page">
        <section className="collab-hero">
          <div className="collab-hero-content">
            <h1 className="collab-hero-title">Castración en gatos</h1>
        ...
        <div className="collab-container">
          <section className="collab-section">
            <h2 className="collab-section-title">Ventajas de la castración</h2>
          ...
          <section className="collab-section">
            <h2 className="collab-section-title">
              <i className="bi bi-1-circle collab-section-icon"></i>
              Beneficios físicos
            </h2>
            <span className="collab-text">
          ...
          <section className="collab-section">
            <h2 className="collab-section-title">
              <i className="bi bi-2-circle collab-section-icon"></i>
          ...
          <section className="collab-section">
            <h2 className="collab-section-title">Cuándo se debe llevar a cabo</h2>
            <span className="collab-text">
          ...
          <section className="collab-section">
            <h2 className="collab-section-title">La operación</h2>
            <span className="collab-text">
          ...
          <section className="collab-section">
            <h2 className="collab-section-title">Después de la operación</h2>
            <span className="collab-text">
          ...
          <section className="collab-section">
            <h2 className="collab-section-title">Nutrición</h2>
            <span className="collab-text">
