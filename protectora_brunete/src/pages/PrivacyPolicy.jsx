      ...
      <main className="page">
        ...
        <div className="page-container">
          <section className="page-section">
            <h2 className="page-section-title">Responsable del tratamiento</h2>
          ...
          <section className="page-section">
            <h2 className="page-section-title">¿Qué datos personales recogemos?</h2>
            <span className="page-text">
          ...
          <section className="page-section">
            <h2 className="page-section-title">¿Con qué finalidad tratamos tus datos?</h2>
            <span className="page-text">
          ...
          <section className="page-section">
            <h2 className="page-section-title">Base legal del tratamiento</h2>
            <span className="page-text">
          ...
          <section className="page-section">
            <h2 className="page-section-title">¿Durante cuánto tiempo conservamos tus datos?</h2>
            <span className="page-text">
          ...
          <section className="page-section">
            <h2 className="page-section-title">¿A quién comunicamos tus datos?</h2>
            <span className="page-text">
          ...
          <section className="page-section">
            <h2 className="page-section-title">¿Cuáles son tus derechos?</h2>
            <span className="page-text">
          ...
          <section className="page-section">
            <h2 className="page-section-title">Seguridad de los datos</h2>
            <span className="page-text">
